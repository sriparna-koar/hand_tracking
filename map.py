...
#             # Convert NormalizedLandmark objects to numpy arrays
...
#             if index_tip.y < hand_landmarks.landmark[mpHands.HandLandmark.INDEX_FINGER_PIP].y:
#                 # Move cursor
#                 cursor_x = int(index_tip.x * 1920)
#                 cursor_y = int(index_tip.y * 1080)
#                 pyautogui.moveTo(cursor_x, cursor_y)

#             # Check if both index and middle fingers are up
#             if index_tip.y < hand_landmarks.landmark[mpHands.HandLandmark.INDEX_FINGER_PIP].y and \
#                middle_tip.y < hand_landmarks.landmark[mpHands.HandLandmark.MIDDLE_FINGER_PIP].y:
...
# def check_open_app(hand_landmarks):
#     index_tip = hand_landmarks.landmark[mp.solutions.hands.HandLandmark.INDEX_FINGER_TIP]
#     middle_tip = hand_landmarks.landmark[mp.solutions.hands.HandLandmark.MIDDLE_FINGER_TIP]
